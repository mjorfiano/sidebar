<template>
   ...
   <div class="w-64 bg-blue-500 h-screen">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Mellanie Jane Orfiano</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fcrk3-1.fna.fbcdn.net/v/t1.0-9/139800724_3804170843034600_1095428946063069882_n.jpg?_nc_cat=105&ccb=1-3&_nc_sid=a4a2d7&_nc_eui2=AeHusghzpR1u81S_pe7RBsy1rCauEWT6ZQGsJq4RZPplAQUupTDv1hlXxkDA9XNNyrkS6fM22X1nBWtfjSIuxQ_a&_nc_ohc=FNqSnAQkxE8AX8IecIr&_nc_ht=scontent.fcrk3-1.fna&oh=b49001f28b611c38fd4c46cc7a2e2f8b&oe=6081DDE7" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Mellanie Jane Orfiano</h4>
            </div>
        </div>
    </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Mellanie Jane Orfiano</a>
                </div>
